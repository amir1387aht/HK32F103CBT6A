...
******************************例程详细描述*****************************
功能描述:
	本例程描述了如何配置Sleep mode。
	通过调用库函数PWR_EnterSleepMode()来完成对Sleep mode的配置，程序运行后延时一段时间后进入sleep，
	按下按键KEY3退出sleep，然后又重新进入sleep，每次唤醒后翻转LED1。
...
如何使用:
	...
	2. 下载程序后约5s进入sleep，按下按键唤醒后又重新进入sleep
***********************************************************************