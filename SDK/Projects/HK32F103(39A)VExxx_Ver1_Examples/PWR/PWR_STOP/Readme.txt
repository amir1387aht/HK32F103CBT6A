...
******************************例程详细描述*****************************
功能描述:
	本例程描述了如何配置进入和唤醒Stop mode。
	通过调用库函数PWR_EnterSTOPMode()来完成对Stop mode的配置，程序运行后约5s进入stop，
	按下按键KEY3退出stop，将系统时钟重新配置为进入stop之前的系统时钟HSE+PLL72M，5s后又重新进入stop，每次唤醒后翻转LED1；
...
如何使用:
	...
	2. 下载程序后约5s进入stop，按下按键KEY3唤醒后约5s又重新进入stop
***********************************************************************