...
******************************例程详细描述*****************************
功能描述:
	本例程描述了USART的Printf配置使用。
	通过调用库函数HK32F103xC,HK32F103xD,HK32F103xE,HK32F103xxxxA_USART来完成对USART的Printf配置，BPS为115200，
	通过串口打印USART Printf Example: retarget the C library printf function to the USART
