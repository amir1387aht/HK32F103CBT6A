...
#define VCP_USARTx                        USART1
#define VCP_USARTx_CLK                    RCC_APB2Periph_USART1
#define VCP_USARTx_TX_PIN                 GPIO_Pin_9
#define VCP_USARTx_TX_GPIO_PORT           GPIOA
#define VCP_USARTx_TX_GPIO_CLK            RCC_APB2Periph_GPIOA
#define VCP_USARTx_RX_PIN                 GPIO_Pin_10
#define VCP_USARTx_RX_GPIO_PORT           GPIOA
#define VCP_USARTx_RX_GPIO_CLK            RCC_APB2Periph_GPIOA
#define VCP_USARTx_IRQn                   USART1_IRQn
#define VCP_USARTx_IRQHandler             USART1_IRQHandler
