...
* @filename:  hk32f103xxxxa_eval_i2c_tsensor.c
* @brief:     This file provides a set of functions needed to manage the I2C LM75 temperature sensor.
* @author:    AE Team
...
ErrorStatus LM75_GetStatus(void)
{
    ...
    /*!< EV5 */
    while ((!I2C_GetFlagStatus(LM75_I2C, I2C_FLAG_SB)) && I2C_TimeOut) 
    {
        I2C_TimeOut--;
    }
