...
/** @addtogroup HK32F103xxxxA
  * @{
  */

/** @addtogroup HK32F103xxxxA_eval_spi
  * @{
  */
...
/* Private functions ---------------------------------------------------------*/
void SD_LowLevelInit(void);
void SD_LowLevelDeInit(void);
...
uint8_t SD_WriteByte(uint8_t Data)
{
    ...
    return SPI_I2SReceiveData(SD_SPI);
}
...
uint8_t SD_ReadByte(void)
{
    ...
    /* Send the byte */
    SPI_I2SSendData(SD_SPI, SD_DUMMY_BYTE);
