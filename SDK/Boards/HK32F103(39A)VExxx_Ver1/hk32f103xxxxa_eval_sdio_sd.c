...
* @filename:  hk32f103xxxxa_eval_sdio_sd.c
* @brief:     This file provides a set of functions needed to manage the SDIO SD
*             Card memory mounted on HK32F103xxxxA evaluation Board(refer to hk32f103xxxxa_eval.h
*             to know about the boards supporting this memory).
* @author:    AE Team
* @version:   V1.0.0/2023-10-27
*             1.Initial version
* @log:
*******************************************************************************/
...
/** @defgroup HK32F103xxxxA_EVAL_SDIO_SD
  ...
  *          from/to this memory. The needed HK32 hardware resources (SDIO and
  *          GPIO) are defined in sdio_sd.h file, and the initialization is
  *          performed in SD_LowLevel_Init() function declared in hk32f103xxxxa_eval.c
  *          file.
  ...
  *                  "SDIO_INIT_CLK_DIV" define inside the hk32f103xxxxa_eval.h file.
  ...
  *                  define inside the hk32f103xxxxa_eval.h file.
  *                  The SD Card frequency (SDIO_CK) is computed as follows:
  *
  *                     +---------------------------------------------+
  *                     | SDIO_CK = SDIOCLK / (SDIO_INIT_CLK_DIV + 2) |
  ...
  *             "SD_DMA_MODE" or "SD_POLLING_MODE" inside the hk32f103xxxxa_eval_sdio_sd.h
  ...
  *
  *
  *          HK32 SDIO Pin assignment
  *          =========================
  *          +-----------------------------------------------------------+
  *          |                     Pin assignment                        |
  *          +-----------------------------+---------------+-------------+
  *          |     HK32F103xxxxA SDIO Pins      |     SD        |    Pin      |
  *          +-----------------------------+---------------+-------------+
  *          |      SDIO D2                |   D2          |    1        |
  *          |      SDIO D3                |   D3          |    2        |
  *          |      SDIO CMD               |   CMD         |    3        |
...
/** @defgroup HK32F103xxxxA_EVAL_SDIO_SD_Private_Types
  * @{
  */
/**
  * @}
...
/** @defgroup HK32_EVAL_SDIO_SD_Private_Defines
  * @{
  */
/**
...
/** @defgroup HK32_EVAL_SDIO_SD_Private_Macros
  * @{
  */
/**
  * @}
...
/** @defgroup HK32_EVAL_SDIO_SD_Private_Variables
  * @{
  */
...
/** @defgroup HK32_EVAL_SDIO_SD_Private_Function_Prototypes
  * @{
  */
...
/** @defgroup HK32_EVAL_SDIO_SD_Private_Functions
  * @{
  */
...
SD_Error SD_ReadBlock(uint8_t *readbuff, uint64_t ReadAddr, uint16_t BlockSize)
{
    ...
    /*********************************************************************************/
    /* Added£¬Without this section, it is easy to get stuck in DMA detection
     * Set Block Size for Card£¬cmd16,
     * In case of an sdsc card, cmd 16 can be used to set the block size
     * In the case of an sdhc card, the block size is 512 bytes and is not affected by cmd16
     */
...
static SD_Error FindSCR(uint16_t rca, uint32_t *pscr)
{
    ...
    while (!(SDIO->STA & (SDIO_FLAG_RXOVERR | SDIO_FLAG_DCRCFAIL | SDIO_FLAG_DTIMEOUT | SDIO_FLAG_DBCKEND | SDIO_FLAG_STBITERR)))
    {
        /* Determine whether the received data is available */
