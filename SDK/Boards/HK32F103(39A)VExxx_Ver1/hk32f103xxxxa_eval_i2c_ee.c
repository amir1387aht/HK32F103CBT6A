...
* @filename:  hk32f103xxxxa_eval_i2c_ee.c
* @brief:     This file provides a set of functions needed to manage the I2C HK24C02 EEPROM.
* @author:    AE Team
...
/* Includes ------------------------------------------------------------------*/
#include "hk32f103xxxxa_eval_i2c_ee.h"
...
/**
  * @brief  Start and End of critical section:
  * @param  None.
  * @retval None.
  */
