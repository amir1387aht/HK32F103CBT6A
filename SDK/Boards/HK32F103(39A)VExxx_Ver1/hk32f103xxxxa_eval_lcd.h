...
* @filename:  hk32f103xxxxa_eval_lcd.h
* @brief:     hk32f103xxxxa eval lcd  configuration file.
...
#ifndef      __HK32F103xxxxA_EVAL_LCD_H
#define	     __HK32F103xxxxA_EVAL_LCD_H
...
#define      FSMC_Addr_ILI9341_CMD         ( ( uint32_t ) 0x60400000 )

//FSMC_Bank1_NORSRAM用于LCD数据操作的地址      
#define      FSMC_Addr_ILI9341_DATA        ( ( uint32_t ) 0x60420000 )
...
//PE5为FSMC_A21 PE6为FSMC_A22
#define      ILI9341_CS1_CLK                RCC_APB2Periph_GPIOE   
#define      ILI9341_CS1_PORT               GPIOE
#define      ILI9341_CS1_PIN                GPIO_Pin_5

#define      ILI9341_CS2_CLK                RCC_APB2Periph_GPIOE   
#define      ILI9341_CS2_PORT               GPIOE
#define      ILI9341_CS2_PIN                GPIO_Pin_6
//写使能
